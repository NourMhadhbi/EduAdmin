...
<body>
    ...
    <div class="nav">
        <ul class="nav-menu">
            <li><a href="interface_accueil.html"><i class="fas fa-home"></i> Tableau de Bord</a></li>
            <li><a href="interface_utilisateurs.html"><i class="fas fa-users"></i> Gestion Utilisateurs</a></li>
            <li><a href="interface_suivi.html" class="active"><i class="fas fa-chart-line"></i> Suivi & Contrôle</a>
            </li>
        </ul>
    </div>
